...
$query="INSERT INTO `tutify`.`profile_t`(`address`, `postal_code`, `area`, `country`, `state`, `ehistory`, `experience`, `degree`, `picture`, `id`) VALUES ('$address','$postal_code','$area','$coutry','$state','$ehistory','$experience','$degree','$picture','$id')";
    ...
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="p-3 py-6">
                    ...
                    <div class="col-md-12"><label class="labels">Additional Details</label><input type="text" class="form-control" placeholder="additional details" name="detail" ></div>
                    </div>
